...
export default function TimelineItem(props) {
  ...
  const { id, date, title, company, location, description } = experience;
  ...
  return (
    <li className="lg:ml-5 py-5 lg:py-10" key={title}>
      ...
      <div className="p-4 lg:p-3 hover:bg-white hover:bg-opacity-5 hover:backdrop-blur-lg hover:rounded drop-shadow-lg ease-in duration-100 ">
